                ...
                <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2">
                    ...
                    <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700 md:tw-border-t-0 md:tw-border-l">
                        <div class="tw-flex tw-items-center">
                            ...
                            <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                                <a href="https://laracasts.com" class="tw-underline tw-text-gray-900 dark:tw-text-white"
                                    >Laracasts</a
                                >
                            </div>
                        </div>
                    ...
                    <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700">
                        <div class="tw-flex tw-items-center">
                            ...
                            <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                                <a href="https://laravel-news.com/" class="tw-underline tw-text-gray-900 dark:tw-text-white"
                                    >Laravel News</a
                                >
                            </div>
                        </div>
                    ...
                    <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700 md:tw-border-l">
                        ...
                        <div class="tw-ml-12">
                            <div class="tw-mt-2 tw-text-gray-600 dark:tw-text-gray-400 tw-text-sm">
                                ...
                                <a href="https://envoyer.io" class="tw-underline">Envoyer</a> help you take your projects
                                ...
                                <a href="https://laravel.com/docs/telescope" class="tw-underline">Telescope</a>, and more.
                            </div>
                        </div>
                    </div>
                </div>
